...
import { check, PERMISSIONS, request, RESULTS, checkLocationAccuracy } from 'react-native-permissions';
      ...
      <TouchableOpacity
        style={[
          styles.shadow,
          {
            ...
            padding: 20,
            position: 'absolute',
            bottom: insets.bottom + normalize(100),
            left: 10,
            right: 0,
            width: SCREEN_WIDTH - 20,
            flexDirection: 'row',
        ...
        <WText m style={{ fontSize: 16, marginLeft: 12, flex: 1 }}>
          이용시간 설정하기
        </WText>
