...
import { ScrollView, Image, View, TouchableOpacity, Button, TouchableWithoutFeedback, StyleSheet } from "react-native";
        ...
        <View style={{paddingHorizontal: 15, paddingVertical: 20}}>
          ...
          <View style={{flexDirection:'row', alignItems:'center',marginTop:12,justifyContent:'space-between'}}>
            <View style={[styles.container,{alignItems:'center',width:normalize(105)}]}>
                    ...
                    <View style={{position:'absolute',top:0,left:0,backgroundColor:'rgba(22,125,251,1)',borderRadius:12,padding:3,paddingHorizontal:5,width:normalize(80),transform:[{translateY:-10}]}}><WText b style={{fontSize:10,color:'#fff'}}>무제한 50% 할인</WText></View>
                </View>
                <View style={[styles.container,{alignItems:'center',width:normalize(105)}]}>
                    <Image style={{width:normalize(25),height:normalize(25)}} source={Img.socar_card}/>
                    <WText style={{marginTop:12}}>쏘카카드</WText>
                    <View style={{position:'absolute',top:0,left:0,backgroundColor:'rgba(22,125,251,1)',borderRadius:12,padding:3,paddingHorizontal:5,width:normalize(80),transform:[{translateY:-10}]}}><WText b style={{fontSize:10,color:'#fff'}}>최대 10만원 혜택</WText></View>
                </View>
                <View style={[styles.container,{alignItems:'center',width:normalize(105)}]}>
          ...
          <View style={{marginTop:16, flexDirection:'row',alignItems:'center',padding:16}}>
                 ...
                 <View style={{flex:1,marginLeft:20}}>
                    <WText b style={{fontSize:15}}>이용 가이드</WText>
          ...
          <View style={{flexDirection:'row', alignItems:'center',marginTop:12,justifyContent:'space-between'}}>
            <View style={[styles.container,{width:normalize(165)}]}>
                    <WText m style={{fontSize:16}}>쏘카페어링</WText>
                ...
                <View style={[styles.container,{width:normalize(165)}]}>
                    <WText m style={{fontSize:16}}>쏘카마이존</WText>
...
<WText m style={{fontSize:16}}>쏘카 스토리</WText>
...
<Image style={{width:normalize(165),height:normalize(220)}} source={Img.story4}/>
  ...
  const IMAGE_ARRAY= ['https://source.unsplash.com/random/375x375','https://source.unsplash.com/random','https://source.unsplash.com/random/400x400','https://source.unsplash.com/random/401x401','https://source.unsplash.com/random/402x402','https://source.unsplash.com/random/403x403','https://source.unsplash.com/random/1','https://source.unsplash.com/random/2']
  ...
  const IMAGE_MIDDLE_ARRAY= ['https://source.unsplash.com/random/1','https://source.unsplash.com/random/2','https://source.unsplash.com/random/3','https://source.unsplash.com/random/4','https://source.unsplash.com/random/5','https://source.unsplash.com/random/6','https://source.unsplash.com/random/7','https://source.unsplash.com/random/8']
